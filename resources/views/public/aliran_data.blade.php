        ...
        <div style="display: flex; gap: 16px; align-items: flex-start;">
            ...
            <div>
                ...
                <div style="font-size: 14px; color: var(--muted); margin-top: 4px; line-height: 1.5;">
                    Aliran data memantau apakah <strong>{{ $totalData }} data yang disepakati</strong> sudah dipublikasikan di Sedata Sebantul. Data diupload oleh dinas langsung ke Sedata Sebantul, BPS memantau status tayangnya.
                </div>
            </div>
        </div>
        ...
        <div class="scroll-reveal" style="background: #fff; border: 1px solid var(--line); border-radius: 12px; padding: 24px; box-shadow: var(--shadow-sm); display: flex; flex-direction: column; --delay: 100ms; height: 100%;">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 24px;">
                <div>
                    ...
                    <h3 style="margin: 4px 0 0; font-size: 18px; font-weight: 800; color: var(--navy);">Status Publikasi Data ({{ $totalData }} Data)</h3>
                </div>
                <div style="border: 1px solid var(--line); border-radius: 6px; padding: 6px 12px; font-size: 12px; font-weight: 600; color: var(--navy); display: flex; align-items: center; gap: 4px;">
                    {{ $tahun }} <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"><polyline points="6 9 12 15 18 9"></polyline></svg>
                </div>
            </div>
                    ...
                    <div style="border: 1px solid var(--line); border-radius: 8px; padding: 16px 20px; display: flex; justify-content: space-between; align-items: center; background: #f8f9fb;">
                        <div style="display: flex; gap: 12px; align-items: center;">
                            ...
                            <div>
                                ...
                                <div style="font-size: 12px; color: var(--muted); margin-top: 4px;">{{ $pctTayang }}% &middot; {{ $sudahTayang }} data</div>
                            </div>
                        </div>
                        <div style="font-size: 24px; font-weight: 800; color: #002B6A; font-family: 'JetBrains Mono', monospace;" x-data="countUp({{ $sudahTayang }})" x-text="count">0</div>
                    </div>
                    ...
                    <div style="border: 1px solid var(--line); border-radius: 8px; padding: 16px 20px; display: flex; justify-content: space-between; align-items: center; background: #f8f9fb;">
                        <div style="display: flex; gap: 12px; align-items: center;">
                            ...
                            <div>
                                ...
                                <div style="font-size: 12px; color: var(--muted); margin-top: 4px;">{{ $pctBelum }}% &middot; {{ $belumTayang }} data</div>
                            </div>
                        </div>
                        <div style="font-size: 24px; font-weight: 800; color: var(--muted); font-family: 'JetBrains Mono', monospace;" x-data="countUp({{ $belumTayang }})" x-text="count">0</div>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div style="display: flex; flex-direction: column; gap: 16px; height: 100%;">
            <div class="scroll-reveal" style="flex: 1; background: #fff; border: 1px solid var(--line); border-radius: 12px; padding: 20px; box-shadow: var(--shadow-sm); display: flex; gap: 16px; align-items: center; --delay: 200ms;">
                ...
                <div>
                    ...
                    <div style="display: flex; align-items: baseline; gap: 8px;">
                        <span style="font-size: 32px; font-weight: 800; color: var(--navy); font-family: 'JetBrains Mono', monospace; line-height: 1;" x-data="countUp({{ $totalData }})" x-text="count">0</span>
                        <span style="font-size: 11px; font-weight: 600; color: var(--muted); font-family: 'JetBrains Mono', monospace;">data disepakati {{ $tahun }}</span>
                    </div>
                </div>
            </div>
            ...
            <div class="scroll-reveal" style="flex: 1; background: #fff; border: 1px solid var(--line); border-radius: 12px; padding: 20px; box-shadow: var(--shadow-sm); display: flex; gap: 16px; align-items: center; --delay: 300ms;">
                ...
                <div>
                    ...
                    <div style="display: flex; align-items: baseline; gap: 8px;">
                        <span style="font-size: 32px; font-weight: 800; color: #002B6A; font-family: 'JetBrains Mono', monospace; line-height: 1;" x-data="countUp({{ $sudahTayang }})" x-text="count">0</span>
                        <span style="font-size: 11px; font-weight: 600; color: var(--muted); font-family: 'JetBrains Mono', monospace;">{{ $pctTayang }}% terpublikasi</span>
                    </div>
                </div>
            </div>
            ...
            <div class="scroll-reveal" style="flex: 1; background: #fff; border: 1px solid var(--line); border-radius: 12px; padding: 20px; box-shadow: var(--shadow-sm); display: flex; gap: 16px; align-items: center; --delay: 400ms;">
                ...
                <div>
                    ...
                    <div style="display: flex; align-items: baseline; gap: 8px;">
                        <span style="font-size: 32px; font-weight: 800; color: #EB891B; font-family: 'JetBrains Mono', monospace; line-height: 1;" x-data="countUp({{ $belumTayang }})" x-text="count">0</span>
                        <span style="font-size: 11px; font-weight: 600; color: var(--muted); font-family: 'JetBrains Mono', monospace;">{{ $pctBelum }}% belum tayang</span>
                    </div>
                </div>
            </div>
        </div>
