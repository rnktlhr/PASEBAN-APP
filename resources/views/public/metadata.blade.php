    ...
    <div style="background: #fff; border: 1px solid var(--line); border-radius: var(--radius); overflow: hidden; box-shadow: var(--shadow-sm);">
        <div class="table-responsive">
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid var(--line);" x-show="search === '' || $el.dataset.search.toLowerCase().includes(search.toLowerCase())" data-search="{{ addslashes(strtolower($item->kegiatanStatistik->dinas->singkatan ?? '')) }} {{ addslashes(strtolower($item->kegiatanStatistik->nama)) }}">
