    ...
    <div style="display: grid; grid-template-columns: 1.5fr 1fr; gap: 24px; margin-bottom: 8px;" class="cards-grid">
        ...
        <div style="background: #fff; border: 1px solid var(--line); border-radius: 12px; padding: 24px; box-shadow: var(--shadow-sm);">
            <div style="display: flex; justify-content: space-between; align-items: flex-start; margin-bottom: 24px;">
                <div>
                    <h2 style="margin: 0; font-size: 22px; font-weight: 800; color: var(--navy);">Capaian Romantik Tahun {{ $tahun }}</h2>
                </div>
            ...
            <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;" class="summary-stats-grid">
                <div class="scroll-reveal" style="background: #f8f9fb; border: 1px solid var(--line); border-radius: 10px; padding: 16px; --delay: 100ms;">
                    <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                        <div style="font-size: 13px; font-weight: 600; color: var(--muted);">Total Romantik {{ $tahun }}</div>
                ...
                <div class="scroll-reveal" style="background: #f8f9fb; border: 1px solid var(--line); border-radius: 10px; padding: 16px; --delay: 200ms;">
                    ...
                    <div class="mono" style="margin-top: 12px; font-size: 28px; font-weight: 800; color: #002B6A; line-height: 1;" x-data="countUp({{ $diajukan }})" x-text="count">0</div>
                    <div style="margin-top: 6px; font-size: 12px; font-weight: 600; color: var(--muted);">{{ $pctDiajukan }}% dari total</div>
                </div>
                ...
                <div class="scroll-reveal" style="background: #f8f9fb; border: 1px solid var(--line); border-radius: 10px; padding: 16px; --delay: 300ms;">
                    ...
                    <div class="mono" style="margin-top: 12px; font-size: 28px; font-weight: 800; color: #00B69B; line-height: 1;" x-data="countUp({{ $disetujui }})" x-text="count">0</div>
                    <div style="margin-top: 6px; font-size: 12px; font-weight: 600; color: var(--muted);">{{ $pctDisetujui }}% dari total</div>
                </div>
                ...
                <div class="scroll-reveal" style="background: #f8f9fb; border: 1px solid var(--line); border-radius: 10px; padding: 16px; --delay: 400ms;">
                    ...
                    <div class="mono" style="margin-top: 12px; font-size: 28px; font-weight: 800; color: #EB891B; line-height: 1;" x-data="countUp({{ $belumDiajukan }})" x-text="count">0</div>
                    <div style="margin-top: 6px; font-size: 12px; font-weight: 600; color: var(--muted);">{{ $pctBelum }}% dari total</div>
                </div>
            </div>
        </div>
