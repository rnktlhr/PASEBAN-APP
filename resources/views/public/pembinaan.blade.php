                ...
                <div style="display: flex; align-items: center; gap: 32px; flex: 1;">
                    ...
                    <div style="flex: 1;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                            ...
                            <span style="font-size: 14px; font-weight: 700; color: var(--navy);">{{ $totalKehadiran }}</span>
                        </div>
                        <div style="display: flex; justify-content: space-between; align-items: center;">
                            ...
                            <span style="font-size: 14px; font-weight: 700; color: var(--navy);">{{ ($totalSesi * $totalOPD) - $totalKehadiran }}</span>
                        </div>
                    </div>
                </div>
    ...
    <div style="margin-bottom: 60px;">
        ...
        <div class="summary-cards-grid" style="grid-template-columns: repeat(4, 1fr); gap: 20px;">
            ...
            <div style="background: #fff; border: 1px solid var(--line); border-radius: 12px; padding: 24px; box-shadow: var(--shadow-sm); position: relative; overflow: hidden;">
                <div style="position: absolute; top: 24px; right: 24px; font-size: 24px; font-weight: 800; color: var(--bg); z-index: 0; user-select: none;">{{ str_pad($program->nomor_urut, 2, '0', STR_PAD_LEFT) }}</div>
