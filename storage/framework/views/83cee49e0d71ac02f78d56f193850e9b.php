...
<div class="container" style="padding: 40px 32px; min-height: calc(100vh - 74px);" x-data="{ search: '' }">
    <div style="margin-bottom: 24px; display: flex; justify-content: space-between; align-items: flex-end; gap: 24px;">
        <div>
    ...
    <div style="background: #fff; border: 1px solid var(--line); border-radius: var(--radius); overflow: hidden; box-shadow: var(--shadow-sm);">
        <div class="table-responsive">
            ...
            <tbody>
                ...
                <tr style="border-bottom: 1px solid var(--line);" x-show="search === '' || $el.dataset.search.toLowerCase().includes(search.toLowerCase())" data-search="<?php echo e(addslashes(strtolower($item->kegiatanStatistik->dinas->singkatan ?? ''))); ?> <?php echo e(addslashes(strtolower($item->kegiatanStatistik->nama))); ?> <?php echo e(addslashes(strtolower($item->nama_data))); ?>">
