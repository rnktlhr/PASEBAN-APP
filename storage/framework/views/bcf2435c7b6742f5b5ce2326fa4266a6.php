<?php $__env->startSection('content'); ?>
    <div class="container" style="padding: 40px 32px 0;">
        ...
        <div style="display: grid; grid-template-columns: 1.5fr 1fr; gap: 24px; margin-bottom: 8px;" class="cards-grid">
            ...
            <div
                ...
                <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 16px;" class="summary-stats-grid">
                    <div class="scroll-reveal"
                        style="background: #f8f9fb; border: 1px solid var(--line); border-radius: 10px; padding: 16px; --delay: 100ms;">
                        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                            <div style="font-size: 13px; font-weight: 600; color: var(--muted);">Total Romantik <?php echo e($tahun); ?>

                            </div>
                            <div
                                style="color: var(--muted); background: #fff; border: 1px solid var(--line); width: 24px; height: 24px; border-radius: 6px; display: grid; place-items: center;">
                        ...
                        <div class="mono"
                            style="margin-top: 12px; font-size: 28px; font-weight: 800; color: var(--navy); line-height: 1;"
                    ...
                    <div class="scroll-reveal"
                        style="background: #f8f9fb; border: 1px solid var(--line); border-radius: 10px; padding: 16px; --delay: 200ms;">
                        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                            <div style="font-size: 13px; font-weight: 600; color: var(--muted);">Sudah Diajukan</div>
                            <div
                                style="color: #002B6A; background: #fff; border: 1px solid var(--line); width: 24px; height: 24px; border-radius: 6px; display: grid; place-items: center;">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2">
                        ...
                        <div class="mono"
                            style="margin-top: 12px; font-size: 28px; font-weight: 800; color: #002B6A; line-height: 1;"
                            x-data="countUp(<?php echo e($diajukan); ?>)" x-text="count">0</div>
                        <div style="margin-top: 6px; font-size: 12px; font-weight: 600; color: var(--muted);">
                            <?php echo e($pctDiajukan); ?>% dari total</div>
                    </div>

                    <div class="scroll-reveal"
                        style="background: #f8f9fb; border: 1px solid var(--line); border-radius: 10px; padding: 16px; --delay: 300ms;">
                        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                            <div style="font-size: 13px; font-weight: 600; color: var(--muted);">Disetujui BPS</div>
                            <div
                                style="color: #00B69B; background: #fff; border: 1px solid var(--line); width: 24px; height: 24px; border-radius: 6px; display: grid; place-items: center;">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2.5">
                        ...
                        <div class="mono"
                            style="margin-top: 12px; font-size: 28px; font-weight: 800; color: #00B69B; line-height: 1;"
                            x-data="countUp(<?php echo e($disetujui); ?>)" x-text="count">0</div>
                        <div style="margin-top: 6px; font-size: 12px; font-weight: 600; color: var(--muted);">
                            <?php echo e($pctDisetujui); ?>% dari total</div>
                    </div>

                    <div class="scroll-reveal"
                        style="background: #f8f9fb; border: 1px solid var(--line); border-radius: 10px; padding: 16px; --delay: 400ms;">
                        <div style="display: flex; justify-content: space-between; align-items: flex-start;">
                            <div style="font-size: 13px; font-weight: 600; color: var(--muted);">Belum Diajukan</div>
                            <div
                                style="color: #EB891B; background: #fff; border: 1px solid var(--line); width: 24px; height: 24px; border-radius: 6px; display: grid; place-items: center;">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                    stroke-width="2">
                                    <path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"></path>
                                    <polyline points="14 2 14 8 20 8"></polyline>
                        ...
                        <div class="mono"
                            style="margin-top: 12px; font-size: 28px; font-weight: 800; color: #EB891B; line-height: 1;"
                            x-data="countUp(<?php echo e($belumDiajukan); ?>)" x-text="count">0</div>
                        <div style="margin-top: 6px; font-size: 12px; font-weight: 600; color: var(--muted);">
                            <?php echo e($pctBelum); ?>% dari total</div>
                    </div>
                </div>
            </div>
            ...
            <div
                style="background: #fff; border: 1px solid var(--line); border-radius: 12px; padding: 24px; box-shadow: var(--shadow-sm); display: flex; flex-direction: column;">
                ...
                <div
                    style="display: flex; justify-content: center; flex-wrap: wrap; gap: 16px; font-size: 12px; color: var(--muted); margin-top: 8px;">
                    <div style="display: flex; align-items: center; gap: 6px;"><span
                            style="width: 12px; height: 12px; border-radius: 3px; background: #002B6A;"></span>Sudah
                        diajukan</div>
                    <div style="display: flex; align-items: center; gap: 6px;"><span
                            style="width: 12px; height: 12px; border-radius: 3px; background: #EB891B;"></span>Belum
                        diajukan</div>
                </div>
            </div>
        </div>
