...
<div class="container" style="padding: 40px 32px; min-height: calc(100vh - 74px);">
    ...
    <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if(count($programPembinaan) > 0): ?>
    <!-- Program Tahunan -->
    <div style="margin-bottom: 60px;">
        ...
        <div class="summary-cards-grid" style="grid-template-columns: repeat(4, 1fr); gap: 20px;">
            ...
            <div style="background: #fff; border: 1px solid var(--line); border-radius: 12px; padding: 24px; box-shadow: var(--shadow-sm); position: relative; overflow: hidden;">
                ...
                <h3 style="font-size: 16px; font-weight: 700; color: var(--navy); margin: 0 0 8px; position: relative; z-index: 1;"><?php echo e($program->nama); ?></h3>
                <p style="color: var(--muted); font-size: 13.5px; line-height: 1.5; margin: 0 0 20px; position: relative; z-index: 1;"><?php echo e($program->deskripsi); ?></p>
                <div style="display: inline-flex; align-items: center; gap: 6px; padding: 6px 10px; background: var(--bg); border-radius: 6px; font-size: 12px; font-weight: 600; color: var(--ink);">
                    ...
                    <?php echo e($program->kuartal); ?> <span style="color: var(--muted); font-weight: 400; margin-left: 4px;"><?php echo e($program->jadwal); ?></span>
                </div>
                <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php if($program->link): ?>
                <div style="margin-top: 20px;">
                    <a href="<?php echo e($program->link); ?>" style="color: var(--orange); font-size: 13px; font-weight: 600; display: inline-flex; align-items: center; gap: 4px; text-decoration: none;">Selengkapnya <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg></a>
                </div>
    ...
    <div style="margin-bottom: 60px;">
        <div style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 24px;">
            ...
            <a href="<?php echo e(route('berita-acara.index')); ?>" style="display: inline-flex; align-items: center; gap: 8px; padding: 10px 20px; background: #fff; color: var(--orange); border: 1px solid var(--line); border-radius: 30px; font-size: 13px; font-weight: 700; text-decoration: none; box-shadow: var(--shadow-sm); transition: all 0.2s;">
                Lihat Semua
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
            </a>
        </div>
        <div style="display: grid; grid-template-columns: repeat(3, 1fr); gap: 24px;">
            <?php if(\Livewire\Mechanisms\ExtendBlade\ExtendBlade::isRenderingLivewireComponent()): ?><!--[if BLOCK]><![endif]--><?php endif; ?><?php $__currentLoopData = $latestBeritaAcara; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ba): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <div style="background: #fff; border: 1px solid var(--line); border-radius: 12px; overflow: hidden; box-shadow: var(--shadow-sm); display: flex; flex-direction: column;">
                ...
                <div style="padding: 24px; display: flex; flex-direction: column; flex: 1;">
                    ...
                    <a href="<?php echo e(route('berita-acara.show', $ba->id)); ?>" style="color: var(--orange); font-size: 13px; font-weight: 700; text-decoration: none; display: inline-flex; align-items: center; gap: 4px;">
                        Lihat Detail
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><line x1="5" y1="12" x2="19" y2="12"></line><polyline points="12 5 19 12 12 19"></polyline></svg>
                    </a>
                </div>
