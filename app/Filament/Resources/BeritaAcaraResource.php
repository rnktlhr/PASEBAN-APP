...
class BeritaAcaraResource extends Resource
{
    ...
    public static function form(Form $form): Form
    {
        return $form->schema([
            ...
            Forms\Components\Select::make('kategori')->options(['pendampingan' => 'Pendampingan', 'pembinaan' => 'Pembinaan'])->required(),
            Forms\Components\Textarea::make('ringkasan')->columnSpanFull()->rows(4),
        ]);
    }
    public static function table(Table $table): Table
    {
        return $table->columns([
            ...
            Tables\Columns\TextColumn::make('kategori')->badge()->color(fn ($state) => $state === 'pembinaan' ? 'primary' : 'success'),
    ...
    {
        return ['index' => Pages\ListBeritaAcara::route('/'), 'create' => Pages\CreateBeritaAcara::route('/create'), 'edit' => Pages\EditBeritaAcara::route('/{record}/edit')];
    }
}
