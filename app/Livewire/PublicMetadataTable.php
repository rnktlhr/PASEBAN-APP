...
class PublicMetadataTable extends Component
{
    use WithPagination;
    ...
    {
        $query = Metadata::with('kegiatanStatistik.dinas')->where('tahun', $this->tahun);
        ...
        $metadata = $query->paginate(10);
        $dinasList = Dinas::orderBy('nama')->get();

        return view('livewire.public-metadata-table', compact('metadata', 'dinasList'));
    }
}
